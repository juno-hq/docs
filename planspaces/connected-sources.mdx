...
Code context lets Scott answer with awareness of your actual repositories instead of only the text in an agent session or planspace.
...
Code context helps Scott answer questions and write better plans. [PR design review](/developer-tools/scott-ci) links implementation work back to planspaces after a pull request is opened or updated.
