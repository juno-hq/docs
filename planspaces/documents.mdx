...
Once approved, that version becomes the strongest reference when your agent [pulls context from Scott](/developer-tools/pull) and when the [Scott GitHub App](/developer-tools/scott-ci) reviews a PR.
